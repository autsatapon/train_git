            ...
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <?php echo Form::text('title', null, array('id' => 'title', 'class' => 'small')); ?>
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <?php echo Form::text('started_at', null, array('id' => 'started_at', 'class' => 'ssmall datepicker')); ?>
                        To
                        <?php echo Form::text('ended_at', null, array('id' => 'ended_at', 'class' => 'ssmall datepicker')); ?>
                    </div>
                </div>
