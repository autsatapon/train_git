    ...
    <div class="mws-panel-body no-padding">
        ...
        <form method="post" action="" id="promotion-form" class="mws-form" enctype="multipart/form-data">
            ...
            <fieldset class="mws-form-inline">
                ...
                <?php echo Form::hidden('app_id', $campaign->app_id); ?>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="ssmall datetimepicker" name="start_date" value="<?php echo Input::old('start_date', $campaign->start_date); ?>">
                        To
                        <input type="text" class="ssmall datetimepicker" name="end_date" value="<?php echo Input::old('end_date', $campaign->end_date); ?>">
                    </div>
                </div>
                    ...
                    <div class="mws-form-item">
                        ...
                        <div class="condition-promotion-code-code">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="grid_6">
                                    start with
                                    <?php echo Form::text('conditions[promotion_code][0][start_with]', null, array('class' => 'ssmall', "style" => "text-transform: uppercase;")); ?>
                                    and end with
            ...
            <fieldset class="mws-form-inline effects" id="auto-effect">
                ...
                <div class="mws-form-row effects_discount">
                    <label class="mws-form-label">
                        <?php echo Form::checkbox('effects[type][]', 'discount', true); ?> Discount
                    </label>
                    <div class="mws-form-item">
                        <div class="clearfix">
                            <div class="grid_3">
                                ...
                                <ul class="mws-form-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="effect-discount-on-following-extra">
                                            <?php echo Form::select('effects[discount][which]', array('variant' => 'Variant', 'product' => 'Product', 'brand' => 'Brand', 'collection' => 'Collection'), null, array('id' => 'effect-discount-which', 'onChange' => 'PCMS.ManageItems.removeAllItems($(\'#effects-discount-following_items-popup\')); PCMS.ManageItems.removeAllItems($(\'#effects-exclude_product-following_items-popup\')); PCMS.ManageItems.removeAllItems($(\'#effects-exclude_variant-following_items-popup\'));')); ?>
                                            <input type="hidden" id="effects-discount-following_items" name="effects[discount][following_items]">
                                            <input type="button" id="effects-discount-following_items-popup" class="popup-manage-items btn btn-default" value="Browse"
                                                   data-popup-id="effects-discount-following_items"
                                                   data-popup-type="$('#effect-discount-which').val()"
                                                   data-popup-target-id="effects-discount-following_items"
                                                   data-popup-pkeys='[]'
                                                   data-popup-datas='<?php echo json_encode($effectsDiscountFollowingItemsDatas); ?>'
                                            />
                                            ...
                                            <ul class="following_exclude">
                                                <li id="exclude_product" style="display:none;">
                                                    ...
                                                    <input type="hidden" id="effects-exclude_product-following_items" name="effects[discount][exclude_product][un_following_items]">
                                                    <input type="button" id="effects-exclude_product-following_items-popup" class="popup-manage-items btn btn-default" value="Browse"
                                                            data-popup-id="effects-exclude_product-following_items"
                                                            data-popup-type="exclude-product"
                                                            data-popup-target-id="effects-exclude_product-following_items"
                                                            data-popup-product-pkeys='eval("["+$("#effects-discount-following_items").val()+"]");'
                                                            data-popup-datas='<?php echo json_encode($effectsDiscountExcludeProductUnFollowingItemsDatas); ?>'
                                                     />
                                                ...
                                                <li id="exclude_variant" style="display:none;">
                                                    ...
                                                    <input type="hidden" id="effects-exclude_variant-following_items" name="effects[discount][exclude_variant][un_following_items]">
                                                    <input type="button" id="effects-exclude_variant-following_items-popup" class="popup-manage-items btn btn-default" value="Browse"
                                                            data-popup-id="effects-exclude_variant-following_items"
                                                            data-popup-type="exclude-variant"
                                                            data-popup-target-id="effects-exclude_variant-following_items"
                                                            data-popup-product-pkeys='eval("["+$("#effects-discount-following_items").val()+"]");'
                                                            data-popup-datas='<?php echo json_encode($effectsDiscountExcludeVariantUnFollowingItemsDatas); ?>'
                                                     />
                                                </li>
                                            </ul>
                                        </div>
                ...
                <div class="mws-form-row effects_free hide">
                    <label class="mws-form-label">
                        <?php echo Form::checkbox('effects[type][]', 'free'); ?> Free
                    </label>
                    <div class="mws-form-item">
                        <div class="clearfix">
                            <div class="grid_3">
                ...
                <div class="mws-form-row effects_shipping hide">
                    <label class="mws-form-label">
                        <?php echo Form::checkbox('effects[type][]', 'free_shipping'); ?> Free Shipping
                    </label>
                </div>
