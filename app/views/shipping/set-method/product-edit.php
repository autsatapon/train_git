        ...
        <form method="post" action="" class="mws-form">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">Product Title</label>
                    <div class="mws-form-item">
                        <p style="margin:0; padding:5px 0;"><?php echo $product->title ?></p>
                    </div>
                </div>
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <ul class="mws-form-list shipping-method-row">
                            ...
                            <?php
                                ...
                                $checked = (in_array($shippingMethod->id, $arrProductShippingMethodId)) ? 1 : 0;
                            ?>
                            <li>
                                <label>
