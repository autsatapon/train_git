<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        ...
        <form method="post" action="<?php echo url('banners/groups/update/'.$groups['id']); ?>" class="mws-form">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <select name="banner_position_id" id="banner_position_id">
                            ...
                            <option value="<?php echo $value['id']; ?>" <?php echo ($value['id'] == $groups['banner_position_id']) ? 'selected="selected"' : ""; ?>><?php echo $value['name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" name="name" id="name" value="<?php echo $groups['name']; ?>">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label" for="description">Description</label>
                    <div class="mws-form-item">
                        <?php echo Form::textArea('description', $groups['description'], array('rows' => 5, 'cols' => 45)); ?>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="checkbox" name="is_random" id="is_random" value="Y" <?php echo ($groups['is_random'] == "Y") ? 'checked="checked"' : ""; ?>>
                        Random
                    </div>
                </div>
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        ...
                        */ ?>
                        <select name="show_per_time" id="show_per_time">
                            <?php for ($i = 1; $i < 20; $i++) : ?>
                            <option value="<?php echo $i; ?>" <?php echo ($groups['show_per_time'] == $i) ? 'selected="selected"' : ""; ?>><?php echo $i; ?></option>
                            <?php endfor; ?>
                        </select>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <?php echo Form::select('status_flg', array('Y' => 'Enable', 'N' => 'Disable'), $groups['status_flg'], array('id' => 'status_flg')); ?>
                        
                    </div>
                </div>
            </div>
            <div class="mws-button-row">
                <input type="submit" class="btn btn-primary" name="save-button" id="save-button" value="Update">
                <input type="button" class="btn btn-info" name="cancel-button" id="cancel-button" value="Cancel">
            </div>
        </form>
