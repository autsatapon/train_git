            ...
            <div class="mws-form-inline">
				...
				<div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <div class="row">
                        		...
                        		<input type="text" class="small" name="policy_title" id="policy_title" value="<?php echo Input::old('policy_title',$policy->title) ?>">
					    </div>
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
						  		...
						  		<?php echo Form::ckeditor('policy_description', Input::old('policy_description',$policy->description), array('id' => 'policy_description', 'class' => 'form-control', 'height' => '150px')); ?>
