...
class MWSPresenter {
    ...
    public function getPageRange($start, $end)
    {
        ...
        for ($page = $start; $page <= $end; $page++)
        {
            ...
            {
                $pages[] = '<a class="paginate_active">'.$page.'</a>';
            }
            else
            {
    ...
    public function getPrevious($text = '&laquo;')
    {
        ...
        else
        {
            ...
            return '<a href="'.$url.'" class="paginate_button">'.$text.'</a>';
        }
    }
    ...
    {
        return '<a class="paginate_button">...</a>';
    }
    ...
    public function getLink($page)
    {
        ...
        return '<a href="'.$url.'" class="paginate_button">'.$page.'</a>';
    }
